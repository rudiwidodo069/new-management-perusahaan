        ...
        <div class="container">
            <div class="card mb-3">
                <div class="card-header">
                    <h3 class="title text-center">Form Insert Inventori</h3>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" name="nama_kategori" id="nama_kategori" class="form-control input-group-append" readonly>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group input-group">
                                    ...
                                    <input type="text" name="nama_pt" id="nama_pt" class="form-control input-group-append" readonly>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alamat_pt" id="alamat_pt" class="form-control" readonly>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#btn-insert').on('click', function(e) {
            ...
            $.ajax({
                url: "<?= site_url('manager_menu_inventori_masuk/insert_inventori_masuk') ?>",
                type: "post",
                data: {
                    id_cabang: id_cabang,
